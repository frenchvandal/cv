...
I have interviewed enough people to know how a CV gets read: diagonally, in
thirty seconds, hunting for one exact answer that justifies a decision. A frozen
document answers every question with the same sheet of A4. A web page can lead
...
### Languages, not translations

From Chengdu I work in several languages, and so does this site. Each version is
written for its own reader: a multilingual CV is not a document translated seven
times but the same career told properly seven times over. A multilingual PDF
would be a zip archive; here every language has its own page, indexed and
shareable.
...
question being asked rather than anticipating all of them. This site is my CV
because it does exactly that: it waits for your question.
